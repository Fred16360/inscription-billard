...
SECRET_KEY = 'django-insecure-&u**z_1g#^8dm360dd+#^v$!hb(r$vl)1fzh)*7f9-#@acx&-o'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['inscription.marzat-informatique.fr', '127.0.0.1']
...
EMAIL_HOST = 'email.sondefor.fr'
EMAIL_PORT = 587
EMAIL_HOST_USER = 'f.marzat@sig-fr.com'
EMAIL_HOST_PASSWORD = ';9}dDn.174b5'
EMAIL_USE_TLS = True
